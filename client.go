...
func main() {
	...
	cmd_parser := btcjson.RawCmdParser(func(*btcjson.RawCmd) (btcjson.Cmd, error) {
		return nil, nil
	})

	reply_parser := btcjson.ReplyParser(func(json.RawMessage) (interface{}, error) {
		return nil, nil
	})
	btcjson.RegisterCustomCmd("name_list", cmd_parser, reply_parser, "This is the help string")
